...
4. Crie/Referencie uma nova **branch** e nomeie como `feat/community/SEU_USERNAME`:'git checkout -b feat/community/SEU_USERNAME'
    > Exemplo: 'git checkout -b feat/community/Padovanie'
...
4. Create/Reference a new **branch** and name it `feat/community/YOUR_USERNAME`: `git checkout -b feat/community/YOUR_USERNAME`;
    > Example: `git checkout -b feat/community/Padovanie`
...
4. Crea/Referencia una nueva **branch** y nómbrala `feat/community/TU_USERNAME`: `git checkout -b feat/community/TU_USERNAME`;
    > Ejemplo: `git checkout -b feat/community/Padovanie`
